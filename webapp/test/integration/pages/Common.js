sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/zvwp/asset/myasset/zvwp_asset_myasset/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#Myasset-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#Myasset-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("com.zvwp.asset.myasset.zvwp_asset_myasset.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/zvwp/asset/myasset/zvwp_asset_myasset/localService/mockserver"], function (mockserver) {
