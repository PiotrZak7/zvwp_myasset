...
sap.ui.define([
		...
		return BaseController.extend("com.zvwp.asset.myasset.zvwp_asset_myasset.controller.Master", {
			...
			_onMasterMatched :  function() {
				this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
					function (mParams) {
						...
						var sObjectId = mParams.firstListitem.getBindingContext().getProperty("IdAsset");
			...
			_showDetail : function (oItem) {
				...
				this.getRouter().navTo("object", {
					objectId : oItem.getBindingContext().getProperty("IdAsset")
				}, bReplace);
			},
