sap.ui.define([
	...
	return BaseController.extend("com.zvwp.asset.myasset.zvwp_asset_myasset.controller.AutoRequest", {
		...
		onInit: function () {
			...
			oRouter.getRoute("autoreq").attachMatched(this._onRouteMatched, this);
		...
		_onRouteMatched: function (oEvent) {
			...
			oView.bindElement({
				path: "/OrderHisAdminSet('" + oArgs.autoreqId + "')",
				events: {
